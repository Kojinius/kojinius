...
export function Input({ label, error, hint, required, className, id, ...props }: Props) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        id={inputId}
        className={cn(
          'px-3 py-2.5 rounded-lg border text-sm bg-white transition-colors duration-150 placeholder:text-[#8A9BAC] focus:outline-none',
          error
